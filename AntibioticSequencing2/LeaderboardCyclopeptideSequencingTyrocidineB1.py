...
AminoMass = [57, 71, 87, 97, 99, 101, 103, 113,
...
with open('C:/Users/Matthew/Downloads/dataset_TyrocidineB1.txt', 'r') as file:
    line = file.readlines()
N =int(line[0].strip())
...
answer_str = '\n'.join(peptide_to_str(p) for p in best_peptides)
print(answer_str)